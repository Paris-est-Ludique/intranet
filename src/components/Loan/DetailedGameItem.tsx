...
import type { VolunteerLoan, VolunteerLoanWithoutId } from '@/services/volunteers'
          ...
          {loanChoices.map(({ name, value }) => (
            ...
            >
              <button
                ...
                className={classnames(styles.loanButton, styles[value], loanValues[value] && styles.active)}
                data-message={name}
              >
                <input
                  type="checkbox"
                ...
                />
                <div className={classnames(styles.loanCheckboxImg, styles[`${value}Checkbox`])} />
              </button>
            </li>
          ))}
        </ul>
