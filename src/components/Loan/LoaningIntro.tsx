...
const LoaningIntro: React.FC = (): JSX.Element => (
  <div className={styles.loanThings}>
    ...
    <p>
      Lors du brunch des bénévoles ayant contribué au dernier festival, des boîtes de jeux en trop dans la ludothèque
      seront données, et des boîtes qui passent l'année dans la cave entre deux éditions seront prêtées pour 4 mois.
    </p>
    <p>
      ...
      <button
        type="button"
        className={classnames(styles.loanButton, styles.noOpinion, styles.noOpinionCheckbox)}
      >
        &nbsp;
      </button>
      {' '}
