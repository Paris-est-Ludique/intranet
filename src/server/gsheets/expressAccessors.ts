...
export interface CustomSetReturn<Element> { toDatabase: Element; toCaller: any }
export interface CustomAddReturn<Element> { toDatabase: Omit<Element, 'id'>; toCaller: any }
